...
/obj/machinery/door/airlock/tram/emag_act(mob/living/user)
...
/obj/machinery/door/airlock/tram/proc/start_malfunction()
	if(obj_flags & EMAGGED)
		return
...
/obj/machinery/door/airlock/tram/proc/end_malfunction()
	if(obj_flags & EMAGGED)
		return
